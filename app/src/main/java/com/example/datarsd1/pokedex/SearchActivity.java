    ...
    public void onClick(View v)
    {
        switch (v.getId())
        {
                        ...
                        .setPositiveButton("Filter",
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,int id) {
                                        ...
                                        filterbyminstat(currminhp, currminatk, Double.parseDouble(definput.getText().toString()));
                                    }})
            ...
            case R.id.typefilter:
                LayoutInflater tli = LayoutInflater.from(context);
                ...
                AlertDialog.Builder typeAlertDialogBuilder = new AlertDialog.Builder(context);
